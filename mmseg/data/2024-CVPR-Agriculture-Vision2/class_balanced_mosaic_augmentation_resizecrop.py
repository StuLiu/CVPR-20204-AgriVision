...
class Mosaic:
    ...
    def doMosaic(self, name):
        ...
        out_img = torch.zeros((5, 1024, 1024)).cuda()
        ...
        sio.imsave(str(img_path), out_img)
        sio.imsave(str(ann_path), out_ann)


if __name__ == "__main__":
    # count class distribution
    folder_path = "/mnt/home/liuwang_data/documents/datasets/seg/2024-CVPR-Agriculture-Vision/supervised/Agriculture-Vision-2021-MMSeg-RGBNM/ann_dir/train_val_mosaic/"
    class_counts, images_containing_class = count_class_distribution(folder_path)

    # class-balanced mosaic
    img_dir = "/mnt/home/liuwang_data/documents/datasets/seg/2024-CVPR-Agriculture-Vision/supervised/Agriculture-Vision-2021-MMSeg-RGBNM/img_dir/train_val_mosaic/"
    ann_dir = "/mnt/home/liuwang_data/documents/datasets/seg/2024-CVPR-Agriculture-Vision/supervised/Agriculture-Vision-2021-MMSeg-RGBNM/ann_dir/train_val_mosaic/"
