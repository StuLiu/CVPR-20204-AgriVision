...
parser.add_argument(
    "-c", "--config", default="config/DeepLabV3Plus-efficientnet-b3-4c.yaml", type=str,
)
...
if __name__ == '__main__':
    ...
    dataset.filenames = dataset.filenames[args.fold * len(dataset.filenames) // args.total_fold:(args.fold + 1) * len(dataset.filenames) // args.total_fold]
